...
import { buypremiemAPI } from '../server/Allapi'
...
// payment 
    const makePremiumPayment = async () => {
        try {
            // Load Stripe
            const stripe = await loadStripe('pk_test_51SeWyeFTAgN0p3P8nTKYzyp9ZSJVFeixJywhV5syBu7Dp0e6Y44F4FAPCTVem0fTMU85p3nyWssCZZ9b2w4XD80d00pzbiupfC')
            ...
            const result = await buypremiemAPI(reqHeader)
            console.log(result)
                    ...
                    <div className='flex flex-wrap'>
                        ...
                        >
                            ...
                            <div className='mt-4 ml-4 gap-6'>
                                ...
                                <button onClick={makePremiumPayment} className='bg-green-600 rounded-4xl mt-10 font-bold' style={{ width: "320px", height: "40px" }}> Buy</button>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div className='mt-4 ml-4 gap-6'>
                                ...
                                <button className='bg-blue-600 rounded-4xl mt-10 font-bold' style={{ width: "320px", height: "40px" }}> Buy</button>
                            </div>
                        </div>
                        <div
                            className='bg-black text-white ml-86 mt-10 rounded-2xl p-4'
                        ...
                        >
                            ...
                            <div className='mt-4 ml-4 gap-6'>
                                ...
                                <button className='bg-purple-600 rounded-4xl mt-10 font-bold' style={{ width: "320px", height: "40px" }}> Buy</button>
                            </div>
                        ...
                        >
                            ...
                            <div className='mt-4 ml-4 gap-6'>
                                ...
                                <button className='bg-yellow-400 rounded-4xl mt-10 font-bold' style={{ width: "320px", height: "40px" }}> Buy</button>
                            </div>
