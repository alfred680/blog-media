        ...
        <>
            <div>
                <div className='rounded-4xl' style={{ height: "700px", backgroundColor: "#EDEFF3", width: "240px ", marginTop: "-10px" }}>
                    ...
                    <div>
                        <div onClick={() => { sethome(true), setprofile(false), setpremium(false), setautor(false) }} className={home ? ' text-white bg-black cursor-pointer h-12 mt-4  rounded-2xl font-bold ' : 'text-black'}>
                        ...
                        <div onClick={() => { setprofile(true), sethome(false), setpremium(false), setautor(false) }} className={profile ? 'text-white bg-black cursor-pointer h-12 rounded-2xl font-bold' : 'text-black'} >
                            <div className='flex' style={{ marginTop: "40px", marginLeft: "10px" }}>
                                <div className='text-2xl' style={{ marginLeft: "30px" }}>
                        ...
                        <div onClick={() => { setprofile(false), sethome(false), setpremium(true), setautor(false) }} className={premium ? 'text-white bg-black cursor-pointer h-12 rounded-2xl font-bold' : 'text-black'} >
                        ...
                        <div onClick={() => { setprofile(false), sethome(false), setpremium(false), setautor(true) }} className={author ? 'text-white bg-black cursor-pointer h-12 rounded-2xl font-bold' : 'text-black'} >
                            <div className='flex' style={{ marginTop: "40px", marginLeft: "10px" }}>
                                <div className='text-2xl' style={{ marginLeft: "30px" }}>
                      ...
                      <hr style={{ marginTop: "240px" }} className='my-6 border-gray-400 ' />
